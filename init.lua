...
-- Custom VIM Commands
  vim.cmd [[command! BufOnly silent! execute ":wa | %bd | e# | bd#"]]
...
require('packer').startup(function(use)
  ...
  dap.adapters.python = function(cb, config)
    if config.request == 'attach' then
      ...
      cb({
        type = 'executable',
        command = '/Users/killo/.virtualenvs/debugpy/bin/python3',
  ...
  use { -- Auto pairs for brackets, quotes, etc
  ...
  --Rename all occurances of the hovered word for the entire file
  ...
  use 'jacoborus/tender.vim' -- colorscheme tender
  use 'patstockwell/vim-monokai-tasty' -- colorscheme vim-monokai-tasty
  ...
  use { 'KilloPillers/telescope-media-files.nvim', branch='symbols', requires = {'nvim-telescope/telescope.nvim'} }
...
-- Enable telescope image previewer
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'javascript', 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'typescript', 'vimdoc' },
